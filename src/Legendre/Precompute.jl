...
#const tabINVcGLquad = zeros(Float64,K_u) # Table of the 1/c_k = (2k+1)/2 associated with the normalisation of the Legendre polynomials for the G-L quadrature
#const tabPGLquad = zeros(Float64,K_u,K_u) # Table of P[k,i]=P_k(u_i) used in the G-L quadrature.
...
function tabGLquad(K_u::Int64)
    #=tabGLquad
     Function to initialise the nodes and weights
     of the G-L quadrature
    =#
